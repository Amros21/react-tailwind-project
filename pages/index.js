        ...
        <section>
          <div>
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-white">
              ...
              consulted for{" "}
              <span className="text-teal-500 dark:text-white">startup</span>and
          ...
          <div className="lg:flex gap-10">
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white">
              <Image
                ...
                className={"mx-auto"}
              />
              <h3 className="text-lg font-medium pt-8 bp-2 ">
                Beautiful Designs
              </h3>
              <p className="py-2 ">
                {" "}
                Creating elegant designs suited for your needs following co re
                design theory.
              </p>
